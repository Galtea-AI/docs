"""
SDK API: Trace Generate - Additional Examples
...
product_id = create_test_product(
    ...
    description="Demo product for trace generate API",
...
result = galtea_client.traces.generate(
    agent=my_agent,
    session=session,
    input="Hello!",
)
...
try:
    result = galtea_client.traces.generate(agent=failing_agent, session=session_error, input="test")
except Exception as e:
    # Galtea context is automatically cleaned up
