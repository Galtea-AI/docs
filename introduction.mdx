...
<CardGroup cols={3}>
  ...
  <Card title="Understand the platform" icon="cube" href="/concepts/product">
    Products, specs, datasets, metrics, and evaluations — the full model.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Generate Metrics & Datasets">Galtea [generates metrics](/concepts/metric/ai-generation) and [datasets](/concepts/product/dataset) from your specifications, or you create them manually.</Step>
  <Step title="Create Version">Define a new [Version](/concepts/product/version) of your product to track changes over time.</Step>
  <Step title="Run Evaluations">Run [Evaluations](/concepts/product/version/session/evaluation) — `evaluations.run()` resolves specs, datasets, and metrics automatically.</Step>
