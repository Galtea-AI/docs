...
You can now [link these models to specific Metrics](/concepts/metric) for consistent evaluation results and leverage specialized models for different evaluation scenarios. Learn more about configuring evaluator models in our [SDK documentation](/sdk/api/metric).
