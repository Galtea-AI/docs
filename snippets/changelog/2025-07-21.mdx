<Update label="2025-07-21" description="Conversation Simulation, New Data Leakage Metric, and Platform Enhancements">
## Test Your Chatbots with Simulated Conversations

It is now possible to generate tests that simulate realistic, multi-turn user interactions. Our new **[Scenario Based Tests](/concepts/product/test/scenario-tests)** allow you to define user personas and goals to evaluate how well your conversational AI handles complex dialogues.
