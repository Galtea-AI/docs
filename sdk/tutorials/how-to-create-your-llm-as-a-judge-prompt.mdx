...
You can use Galtea to [Evaluate with Custom Metrics](/sdk/tutorials/evaluate-with-custom-metrics) and tailor your evaluation with full flexibility. However, this can be highly complex or even impossible in some cases. In this guide we will explain how to translate the idea you want to evaluate into an effective, usable prompt so an LLM can do the judging.
...
<CardGroup cols={2}>
  ...
  <Card title="Evaluate with Custom Scores" icon="calculator" href="/sdk/tutorials/evaluate-with-custom-metrics">
