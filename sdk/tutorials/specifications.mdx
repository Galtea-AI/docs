...
<Info>
  For running evaluations using specifications, see [Specification-Based Evaluation](/sdk/tutorials/create-evaluation#specification-based-evaluation).
</Info>
...
<CardGroup cols={2}>
  <Card title="Run Specification-Based Evaluations" icon="clipboard-check" href="/sdk/tutorials/create-evaluation#specification-based-evaluation">
