...
Set the `OTEL_EXPORTER_OTLP_ENDPOINT` environment variable on your service to point to the Galtea OTEL collector:

```bash
export OTEL_EXPORTER_OTLP_ENDPOINT="https://collector.galtea.ai"
```
