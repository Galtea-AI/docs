...
<Steps>
  ...
  <Step title="Run a Dataset from the Dashboard">
    Select a dataset and run it against the version. Galtea calls your endpoint for each test case and records the inference results.
  </Step>
...
## Step 3: Run a Dataset

Once your version is set up with an endpoint connection, you can run datasets directly from the Dashboard:

1. Navigate to your product's **Datasets** section.
2. Select the dataset you want to run.
3. Choose the version with the configured endpoint connection.
4. Start the dataset run.
