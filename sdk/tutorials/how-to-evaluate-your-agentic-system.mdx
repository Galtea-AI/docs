...
description: "A practical guide for evaluating your agentic system: use Galtea's tracing feature to capture your agent's spans and then define your specific scope of interest by creating a custom metric."
icon: "lightbulb"
---

Use the [`@traced` decorator](/sdk/tutorials/tracing-agent-operations) to capture every operation your agent performs. Once captured, spans become an evaluation parameter called `traces` — the full execution path from user input to system output.
...
<CardGroup cols={2}>
  <Card title="Tracing Agent Operations" icon="sitemap" href="/sdk/tutorials/tracing-agent-operations">
    Capture spans from your agent — required for these metrics to work.
  </Card>
