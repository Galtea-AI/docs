...
<Tip>If your system already emits OpenTelemetry traces, you can create production sessions without any SDK calls. See [Monitor Production via OpenTelemetry](/sdk/tutorials/monitor-production-with-opentelemetry).</Tip>
