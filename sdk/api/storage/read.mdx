...
<ResponseField name="file" type="string | AttachedFile" required>
  The file to fetch: an [`AttachedFile`](/sdk/api/test-case/upload-input-file) read from `test_case.input_files`, `input_data.input_files` or `trace.actual_output_files`, or the URI of any file this organization uploaded.
</ResponseField>
