...
sidebarTitle: "List"
description: "List all test cases associated with a specific dataset."
---

## Returns
Returns a list of [TestCase](/concepts/product/dataset/test-case) objects for the given dataset.
...
<ResponseField name="dataset_id" type="string | list[string]" optional>
  The ID or IDs of the dataset you want to get the test cases from.
...
<Note>
  At least one of the 2 filter parameters (`dataset_id`, `id`) described above must be passed to the method
</Note>