...
<Warning>
  A test case carrying files is **skipped** by every metric that reads the input, because evaluators cannot read files yet. See [File inputs](/concepts/product/dataset/test-case#file-inputs).
</Warning>
