...
<ResponseField name="user_id" type="string | list[string]" optional>
  Filter by the ID of the user who launched the session. Production/OTel-ingested sessions have no launcher and never match this filter. This is an additional filter; it does not satisfy the scoping requirement below.
</ResponseField>
<Note>
