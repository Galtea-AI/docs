...
description: "Create a batch of traces in a session."
---
...
<ResponseField name="session_id" type="string" optional>
  The session ID to log the traces to.
...
<ResponseField name="conversation_turns" type="list[dict]" required>
  ...
  <Note>
    ...
    When set, Galtea also records it as a `RETRIEVER` span on that turn's trace.
  </Note>
