...
<ResponseField name="api_key" type="string" optional>
  New Pipecat Cloud API key. This is a secret. The API never returns it, so you cannot read it back. Leave this field unset to keep the stored key. Pass a value to replace it.
</ResponseField>
<ResponseField name="agent_name" type="string" optional>
  New Pipecat Cloud agent name.
</ResponseField>
