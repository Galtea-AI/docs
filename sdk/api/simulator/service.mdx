...
The [Conversation Simulator](/concepts/product/dataset/test-case/conversation-simulator) is a feature for testing conversational AI systems. The `SimulatorService` in the Galtea SDK allows you to run these simulations programmatically. This service is exposed through the `galtea.simulator` object.
