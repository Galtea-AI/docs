...
<ResponseField name="trace_id" type="Optional[str]">
  The trace ID for this execution. Forward this to remote agents so they can attach spans to the correct session. See [Remote Agent Tracing](/sdk/tutorials/tracing-agent-operations#remote-agent-tracing).
</ResponseField>
