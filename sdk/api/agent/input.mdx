...
<ResponseField name="input_files" type="list[InputFile]">
  The files attached to the last user message, as `InputFile` objects. Empty when the test case carries no file. See [Reading attached files](#reading-attached-files).
</ResponseField>
