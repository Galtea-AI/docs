...
<ResponseField name="http_methods" type="list[string]" optional>
  Filter by HTTP methods. Valid values: `GET`, `POST`, `PUT`, `PATCH`, `DELETE`. Other string values
...
<ResponseField name="auth_types" type="list[string]" optional>
  Filter by authentication types. Valid values: `NONE`, `BEARER`, `API_KEY`, `BASIC`. Other string
