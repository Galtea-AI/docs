...
<ResponseField name="input_template" type="string" optional>
  Input template with Jinja2 placeholders. Required for `CONVERSATION` type. Must contain `{{ input }}`. See [Templates & Mapping](/concepts/product/endpoint-connection-configuration#input-template).
</ResponseField>
