---
title: 'observe'
description: "Drop-in replacement for Langfuse's @observe decorator with Galtea span linking."
---
...
<ResponseField name="inference_result_id" type="str" optional>
  Galtea inference result ID to link spans to. When provided on the **outermost** `@observe` call, the wrapper manages the span context automatically. Consumed by the wrapper — does not reach the decorated function's parameters.
</ResponseField>
