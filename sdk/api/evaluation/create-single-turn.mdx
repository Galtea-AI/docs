...
<Warning>
  **Deprecated**: This method is deprecated and will be removed in a future version.
  ...
  - `galtea.traces.create_and_evaluate()` - Creates a trace and evaluates it in a single call
  - `galtea.evaluations.create(trace_id=...)` - Evaluates an existing trace
</Warning>
...
<ResponseField name="product_id" type="string" optional>
  The ID of the product you want to evaluate, as an alternative to `version_id`. The API resolves the product's latest version, or creates a default one if the product has none yet.
