...
When using `galtea.inference_results.generate()`, span collection is handled automatically:
...
<Tip>
  Use `galtea.inference_results.generate()` for automatic span collection instead of manual collection.
</Tip>
