...
To do so, you define an **agent function** that translates Galtea's input into calls to your product. The SDK supports three signatures — pick the one that matches how much context your agent needs:
