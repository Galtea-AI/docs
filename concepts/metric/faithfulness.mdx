...
The Faithfulness metric is effective for evaluating Accuracy test cases in Galtea, for products that use RAG, since it measures the model's ability to maintain alignment with retrieved context.
