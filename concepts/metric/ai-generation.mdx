...
### From the Specifications Tab (Single Specification)
...
### From the Specifications Tab (Multiple Specifications)
...
- **The manual metric form** — when creating a metric from scratch (**Metrics** in the sidebar → **New Metric** → blank), fill in the name, description, and evaluation type, then click **Complete with AI**.
