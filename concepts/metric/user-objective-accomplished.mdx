...
The User Objective Accomplished metric is effective for evaluating Behavior test cases in Galtea, particularly:

- **Goal-driven conversations** where the user has a specific, verifiable objective.
