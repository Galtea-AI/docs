...
- **`goal`**: The objective the synthetic user is trying to achieve in the conversation.
- **`user_persona`**: The personality traits, communication style, and motivations of the synthetic user.
