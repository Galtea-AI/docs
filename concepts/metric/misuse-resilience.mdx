...
-   **`product_description`**: The description of what your product does (set on the [Product](/concepts/product)).
...
<Info>
  All parameters listed above are required for this metric. The `product_description` must be properly defined at the time the evaluation happens.
</Info>
