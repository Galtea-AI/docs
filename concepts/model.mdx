...
import SdkModelServiceCard from '/snippets/cards/sdk-model-service-card.mdx';
...
- **Model (This Page):** Represents the AI model your product is using. Its primary purpose in Galtea is for **cost estimation and tracking**. You link a Version to a Model to calculate the cost of its traces.
