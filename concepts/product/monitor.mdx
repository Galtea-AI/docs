...
Power users can turn on **Show all tabs** (in User Settings > Advanced) to also get a dedicated **Monitors** tab on the product page. It appears only in **Production** view mode, because monitors watch production sessions; use the Development/Production switch in the sidebar to switch to Production if you do not see it.
