...
The sidebar also has a dedicated **Monitors** entry, under **Product**. It appears only in **Production** view mode, because monitors watch production sessions; use the Development/Production switch in the sidebar to switch to Production if you do not see it.
