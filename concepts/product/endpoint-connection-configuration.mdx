...
| `{{ language_code }}` | ISO 639-1 language code of the test case (e.g. `"es"`). Empty string when no language is set. |
| `{{ language_name }}` | ISO 639-1 English language name of the test case (e.g. `"Spanish"`). Empty string when no language is set. |
