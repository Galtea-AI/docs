...
| `{{ inference_result_id }}` | The inference result ID for this turn (also sent automatically as the `X-Galtea-Inference-Id` HTTP header -- useful for [span collection](/sdk/tutorials/tracing-agent-operations)) |
