  ...
  <Tab title="Upload Your Own Scenarios">
    <Steps>
      <Step title="Create your scenarios file">
        Prepare a CSV file following the scenarios structure shown [below](#example-scenario-tests-and-file-format)
      </Step>
      <Step title="Configure the test">
...
Scenarios are specifically designed to work with Galtea's [Conversation Simulator](/concepts/product/test/case/conversation-simulator). When you run evaluations using scenarios, the system will:
