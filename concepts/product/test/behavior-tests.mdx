...
<ResponseField name="input" type="Text" optional>
  The first message the simulated user sends to start the conversation. If not provided, the system will generate an appropriate opening based on the goal and persona.
