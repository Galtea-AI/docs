...
<ResponseField name="Is Augmentated" type="Boolean">
...
The following properties apply specifically to test cases of type `SCENARIOS` used with the [Conversation Simulator](/concepts/product/test/case/conversation-simulator):
