...
<ResponseField name="Endpoint Connection" type="EndpointConnection">
  The [Endpoint Connection](/concepts/product/endpoint-connection) for the version, which configures how to connect to your AI product's API endpoint for direct inference.
</ResponseField>