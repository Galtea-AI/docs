...
<ResponseField name="Timeout" type="Number">
  Request timeout in seconds. Must be between 1 and 300 seconds. Default: 60 seconds.
</ResponseField>
...
<ResponseField name="Retry Config" type="JSON">
  Optional retry configuration for failed requests. **Example**:
  ```json
  {
    "maxRetries": 3,
    "backoffMs": 1000
