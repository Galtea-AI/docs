...
| `{{ inference_result_id }}` | The inference result ID for this turn (also sent as the `X-Galtea-Inference-Id` header for [span collection](/sdk/tutorials/tracing-agent-operations)) |
