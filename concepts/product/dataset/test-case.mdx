...
Read the files back from `test_case.input_files`.
...
Summarize this contract,A 12-month lease at 900 EUR,contrato-arrendamiento.pdf
,Total due 1450 EUR,factura.pdf;anexo.pdf
```
