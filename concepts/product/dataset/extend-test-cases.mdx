...
<Steps>
  <Step title="Open a generated dataset">
    Pick **Datasets** in the sidebar and open a dataset that Galtea generated. The sidebar keeps **Datasets** behind **More** unless you turn on **Show all tabs** in your settings.
  </Step>
