...
- **[Data Augmentation](/concepts/product/dataset/data-augmentation)** creates new cases by learning from the dataset's **existing cases**. It works on any dataset that has cases, including ones you uploaded.
