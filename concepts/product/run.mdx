...
Evaluation tables and session tables both show a **Run** column and a **Runs** filter, so you can narrow either list down to one launch. Session tables hide both in the Production view, because production traffic never belongs to a Run.
