...
- **How you measure performance**: [Evaluations](/concepts/product/version/session/evaluation) that apply a [Metric](/concepts/metric) to a [Session](/concepts/product/version/session) or to a specific [Trace](/concepts/product/version/session/trace).
