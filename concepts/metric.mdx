...
<ResponseField name="Test Type" type="Enum" required>
  ...
  Possible values:
  - `ACCURACY` (alias: `QUALITY`) - For quality testing and accuracy evaluations
  - `SECURITY` (alias: `RED_TEAMING`) - For security and safety testing
  - `BEHAVIOR` (alias: `SCENARIOS`) - For conversational and multi-turn evaluations
</ResponseField>
